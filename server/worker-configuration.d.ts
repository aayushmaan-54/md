/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: ca46e18cf11835ffff53c6be3963e1a7)
...
interface __BaseEnv_CloudflareBindings {
	...
	BACKEND_BASE_URL: "https://md.aayushmaansoni-dev.workers.dev/api/v1" | "http://localhost:8787/api/v1";
	FRONTEND_URL: "https://md.aayushmaansoni.com" | "http://localhost:5173";
...
declare namespace Cloudflare {
	...
	interface ProductionEnv {
		...
		BACKEND_BASE_URL: "https://md.aayushmaansoni-dev.workers.dev/api/v1";
		FRONTEND_URL: "https://md.aayushmaansoni.com";
		SESSION_TTL_SECONDS: "2592000";
		DATABASE_URL: string;
		DATABASE_URL_POOLED: string;
		UPSTASH_REDIS_REST_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "BACKEND_BASE_URL" | "FRONTEND_URL" | "SESSION_TTL_SECONDS" | "DATABASE_URL" | "DATABASE_URL_POOLED" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN">> {}
}
